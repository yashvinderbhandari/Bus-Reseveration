                ...
                <div className={styles.card2}>
                    <form className={styles.form} onSubmit={verify}>
                        ...
                        <div className={styles.field}>
                            ...
                            <input type="password" placeholder='Enter your Password..' className={styles.inputField} value={password} onChange={(e) => { setPassword(e.target.value) }} />
                        </div>
